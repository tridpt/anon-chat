...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      profile_open: 'Profile and settings',
      profile_title: 'Your profile',
      profile_intro: 'Saved only in this browser. No account is created.',
      profile_alias_label: 'Alias',
      profile_language_label: 'Chat language',
      profile_notifications_title: 'Notifications',
      profile_push_label: 'New message notifications',
      profile_push_desc: 'Receive a notification when your chat partner messages you.',
      profile_push_supported: 'Receive a notification even when GhostChat is closed.',
      profile_push_browser: 'Your browser does not support push notifications.',
      profile_push_blocked: 'Notifications are blocked in your browser settings.',
      profile_push_secure: 'Push notifications need HTTPS when GhostChat is deployed.',
      profile_push_failed: 'Could not update notification settings. Please try again.',
      profile_saved: 'Your settings have been saved.',
      ...
      offline_detail: 'You are offline. We will reconnect when the network returns.',
      reconnect_attempt: 'Reconnect attempt {count}...',
      session_ended_title: 'Chat ended after the connection dropped',
      session_ended_detail: 'We will put you back in the queue when the connection returns.',
      connection_restored: 'Connection restored. Finding a new chat...',
    ...
    vi: {
      ...
      profile_open: 'Hồ sơ và cài đặt',
      profile_title: 'Hồ sơ của bạn',
      profile_intro: 'Chỉ lưu trong trình duyệt này. Không tạo tài khoản.',
      profile_alias_label: 'Biệt danh',
      profile_language_label: 'Ngôn ngữ trò chuyện',
      profile_notifications_title: 'Thông báo',
      profile_push_label: 'Thông báo tin nhắn mới',
      profile_push_desc: 'Nhận thông báo khi người đang chat gửi tin nhắn cho bạn.',
      profile_push_supported: 'Nhận thông báo ngay cả khi GhostChat đã đóng.',
      profile_push_browser: 'Trình duyệt này không hỗ trợ thông báo đẩy.',
      profile_push_blocked: 'Thông báo đang bị chặn trong cài đặt trình duyệt.',
      profile_push_secure: 'Thông báo đẩy cần HTTPS khi GhostChat được triển khai.',
      profile_push_failed: 'Không thể cập nhật cài đặt thông báo. Hãy thử lại.',
      profile_saved: 'Đã lưu cài đặt của bạn.',
      profile_save: 'Lưu cài đặt',
      ...
      offline_detail: 'Bạn đang ngoại tuyến. Chúng tôi sẽ kết nối lại khi mạng hoạt động.',
      reconnect_attempt: 'Đang thử kết nối lại lần {count}...',
      session_ended_title: 'Cuộc trò chuyện đã kết thúc do mất kết nối',
      session_ended_detail: 'Chúng tôi sẽ đưa bạn trở lại hàng đợi khi kết nối khôi phục.',
      connection_restored: 'Đã khôi phục kết nối. Đang tìm cuộc trò chuyện mới...',
